...
过程中的并行和并发动作, 分叉(分岔)与汇合用于对**并发**运行的控制流建模。
**表示：用加粗的水平/竖直的直线段表示**
...
<img src="UML笔记.assets/2502367-20220930115504881-1438061243.png" alt="image" style="zoom:67%;" />
...
<img src="UML笔记.assets/image-20231017155333661.png" alt="image-20231017155333661" style="zoom: 50%;" />

![image-20231017155028759](UML笔记.assets/image-20231017155028759.png)
